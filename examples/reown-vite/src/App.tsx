...
export function App() {
  ...
  return (
    <div className={"pages"}>
      <img
        src="https://raw.githubusercontent.com/blockscout/frontend-configs/refs/heads/main/configs/network-icons/rootstock-short.svg"
        alt="Reown"
        style={{ width: "100px", height: "100px" }}
      />
      <h1>React dApp demo with Rootstock global wallet support</h1>
